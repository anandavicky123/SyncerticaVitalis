  ...
  const plans = [
    {
      ...
      period: "Free Forever",
      description:
        "Perfect for individuals getting started with digital health management",
      features: [
    ...
    },
    {
      ...
      description:
        "Tailored solutions for healthcare organizations and large teams",
      features: [
        "All Pro features",
        ...
        <section className="mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              as your health management needs grow.
            </p>
            ...
            <div className="flex items-center justify-center mb-8">
              <span
                className={`mr-3 ${
                  !isAnnual ? "text-blue-800 font-semibold" : "text-gray-600"
                }`}
              >
                Monthly
              </span>
              ...
              >
                Annual{" "}
                <span className="text-green-600 text-sm">(Save 35%)</span>
              </span>
            </div>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {plans.map((plan, index) => (
              ...
              >
                ...
                <button
                  className={`w-full py-3 px-6 rounded-xl font-semibold transition-all duration-200 ${plan.buttonClass}`}
                >
                  {plan.buttonText}
                </button>
              </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <p className="text-gray-600">
                Absolutely. We use bank-level encryption and are fully HIPAA
                compliant. Your health data is never shared without your
                explicit consent.
              </p>
            </div>
          </div>
        ...
        <section className="text-center">
          <div className="bg-gradient-to-r from-blue-500 to-green-500 rounded-2xl p-8 text-white">
            ...
            <p className="text-xl mb-6 text-blue-100">
              Join thousands of users who trust Syncertica Vitalis with their
              health.
            </p>
            <Link
              href="/signin"
              className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-3 rounded-full font-semibold transition-colors inline-block"
            >
