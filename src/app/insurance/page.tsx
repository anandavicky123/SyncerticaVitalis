    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen">
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/insurance" className="text-blue-700 hover:text-blue-500 font-medium border-b-2 border-blue-500">Insurance</Link>
          </nav>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-blue-800 mb-4">Insurance Finder</h1>
          <p className="text-lg text-gray-600">Find the perfect health insurance plan that fits your needs and budget.</p>
        </section>
        ...
        <section className="mb-16">
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="mb-6">
              <label className="block text-blue-700 mb-2">Search Insurance Providers</label>
              <div className="relative">
                <i className="fas fa-search absolute left-3 top-3 text-gray-400"></i>
                <input type="text" placeholder="Search by provider, plan, or network..." className="pl-10 pr-4 py-2 border border-gray-300 rounded-xl w-full focus:outline-none focus:ring-2 focus:ring-blue-300" />
              </div>
            </div>
            
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div>
                <label className="block text-blue-700 mb-2">Coverage Type</label>
                <select 
              ...
              <div>
                <label className="block text-blue-700 mb-2">Monthly Premium</label>
                <select 
                  value={filters.monthlyPremium}
                  onChange={(e) => handleFilterChange('monthlyPremium', e.target.value)}
                  className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300"
                >
              ...
              <div>
                ...
                <select 
                  ...
                  onChange={(e) => handleFilterChange('deductible', e.target.value)}
                  className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300"
                >
            ...
            <div className="space-y-4">
              {insurancePlans.map((plan) => (
                <div key={plan.id} className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition-all">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="font-semibold text-blue-800 text-lg">{plan.name}</h3>
                      <p className="text-blue-600">{plan.type} · {plan.network}</p>
                    </div>
                    {plan.recommended && (
                      <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">Recommended</span>
                    )}
                  </div>
                  ...
                  <div className="grid md:grid-cols-4 gap-4 mb-4">
                    <div>
                      ...
                      <p className="text-blue-800 font-medium">${plan.monthlyPremium}</p>
                    </div>
                    <div>
                      <p className="text-gray-600 text-sm">Deductible</p>
                      <p className="text-blue-800 font-medium">${plan.deductible.toLocaleString()}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-blue-800 font-medium">{plan.coverage}%</p>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-2xl font-bold text-blue-800">{selectedPlan.name}</h2>
                  <button 
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div>
                    <h3 className="font-semibold text-blue-700 mb-3">Plan Overview</h3>
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-blue-800">${selectedPlan.monthlyPremium}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Annual Deductible:</span>
                        <span className="font-medium">${selectedPlan.deductible.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                  
                  <div>
                    <h3 className="font-semibold text-blue-700 mb-3">Coverage Details</h3>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Primary Care Copay:</span>
                        <span className="font-medium">${selectedPlan.copay}</span>
                      </div>
                      <div className="flex justify-between">
                ...
                <div className="mb-6">
                  <h3 className="font-semibold text-blue-700 mb-3">Plan Features</h3>
                ...
                <div className="bg-blue-50 rounded-xl p-4 mb-6">
                  <h3 className="font-semibold text-blue-700 mb-2">Estimated Annual Cost</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-gray-600">Annual Premiums</p>
                      <p className="text-lg font-bold text-blue-800">${selectedPlan.monthlyPremium * 12}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">With Deductible</p>
                      <p className="text-lg font-bold text-blue-800">${(selectedPlan.monthlyPremium * 12) + selectedPlan.deductible}</p>
                    </div>
                  </div>
                </div>
        ...
        {/* Insurance Education */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-blue-800 mb-6">Understanding Health Insurance</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-blue-700">HMO (Health Maintenance Organization)</h4>
                  <p className="text-sm text-gray-600">Lower costs, requires primary care physician, referrals needed for specialists.</p>
                </div>
                <div>
                  <h4 className="font-medium text-blue-700">PPO (Preferred Provider Organization)</h4>
                  <p className="text-sm text-gray-600">More flexibility, no referrals needed, higher costs, nationwide coverage.</p>
                </div>
                <div>
                  <h4 className="font-medium text-blue-700">EPO (Exclusive Provider Organization)</h4>
                  <p className="text-sm text-gray-600">No referrals needed, must use network providers, moderate costs.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Monthly payment to maintain your insurance coverage.</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Fixed amount you pay for covered services.</p>
                </div>
                <div>
                  <h4 className="font-medium text-blue-700">Out-of-Pocket Maximum</h4>
                  <p className="text-sm text-gray-600">Maximum you&apos;ll pay in a year for covered services.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Insurance Tools */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-blue-800 mb-6">Insurance Tools</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl shadow-lg p-6 card-hover text-center">
              ...
              <h3 className="text-lg font-semibold text-blue-800 mb-2">Cost Calculator</h3>
              <p className="text-gray-600 text-sm mb-4">Estimate your annual healthcare costs</p>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 card-hover text-center">
              ...
              <h3 className="text-lg font-semibold text-blue-800 mb-2">Plan Comparison</h3>
              <p className="text-gray-600 text-sm mb-4">Compare multiple plans side by side</p>
              <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-xl transition-colors">
                Compare Plans
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 card-hover text-center">
              ...
              <h3 className="text-lg font-semibold text-blue-800 mb-2">Provider Search</h3>
              <p className="text-gray-600 text-sm mb-4">Find doctors in your network</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/appointments" className="bg-white rounded-2xl shadow-lg p-6 card-hover block">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-blue-800 mb-2">Find Doctors</h3>
                <p className="text-gray-600">Book appointments with in-network providers</p>
              </div>
            </Link>
