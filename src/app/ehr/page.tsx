...
export default function EHR() {
  ...
  const healthRecords: HealthRecord[] = [
    {
      ...
      details: {
        ...
        notes:
          "Patient's blood pressure is well controlled at 122/78 mmHg. Continue current medication regimen. Follow up in 6 months or sooner if symptoms change. Recommended low sodium diet and regular exercise.",
        vitals: {
    ...
    },
    {
      ...
      details: {
        ...
        notes:
          "Patient reports significant improvement in migraine frequency and intensity. Continue current preventive medication. Discussed trigger identification and lifestyle modifications.",
        vitals: {
    ...
    },
    {
      ...
      details: {
        ...
        notes:
          "Annual physical examination completed. All routine screenings up to date. Patient maintains healthy lifestyle with regular exercise and balanced diet. Continue current health maintenance routine.",
        vitals: {
  ...
  const viewDetails = (record: HealthRecord) => {
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Access and manage your complete medical history in one secure
            location.
          </p>
        </section>
              ...
              <div className="p-6 border-t border-gray-200 bg-gray-50">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-xl font-semibold text-blue-800">
                    Visit Details - {selectedRecord.date}
                  </h3>
                  <button
                  ...
                  <div>
                    ...
                    <div className="bg-white rounded-lg p-4">
                      <ul className="list-disc list-inside text-blue-800 space-y-1">
                        {selectedRecord.details.prescriptions.map(
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="border-l-4 border-purple-500 pl-3">
                  ...
                  <p className="text-sm text-gray-600">
                    Managed with preventive treatment
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <button className="bg-white rounded-2xl shadow-lg p-6 card-hover text-center">
              ...
              <p className="text-gray-600 text-sm">
                Download your complete medical history
              </p>
            </button>

            <Link
              href="/appointments"
              className="bg-white rounded-2xl shadow-lg p-6 card-hover block text-center"
            >
