    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-blue-800 mb-4">AI Symptom Checker</h1>
          <p className="text-lg text-gray-600">Get AI-powered health assessments based on your symptoms. Please note this is for informational purposes only and not a substitute for professional medical advice.</p>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="chat-history h-80 overflow-y-auto p-4 bg-gray-50">
              <div className="chat-message bg-blue-100 rounded-xl p-4 mb-4 ml-auto">
                <p className="text-blue-800">Hello! I&apos;m your AI health assistant. What symptoms are you experiencing today?</p>
              </div>
              <div className="chat-message bg-gray-200 rounded-xl p-4 mb-4 mr-auto max-w-md">
                <p>I&apos;ve had a headache and fever since yesterday, and I&apos;m feeling quite tired.</p>
              </div>
              <div className="chat-message bg-blue-100 rounded-xl p-4 mb-4 ml-auto">
                <p className="text-blue-800">I understand. Have you experienced any nausea, vomiting, or sensitivity to light?</p>
              </div>
              <div className="chat-message bg-gray-200 rounded-xl p-4 mb-4 mr-auto max-w-md">
                <p>No nausea or vomiting, but I do feel a bit sensitive to bright lights.</p>
              </div>
              <div className="chat-message bg-blue-100 rounded-xl p-4 mb-4 ml-auto">
                <p className="text-blue-800">Thank you for the information. Based on your symptoms, I&apos;m generating a health assessment for you.</p>
              </div>
            </div>
          ...
          <div className="mt-8 bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-xl font-semibold text-blue-800 mb-4">Health Assessment Results</h3>
            <div className="mb-6">
              <h4 className="font-medium text-blue-700 mb-2">Possible Conditions</h4>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div>
                <h4 className="font-medium text-blue-700 mb-2">Recommended Medications</h4>
              ...
              <div>
                <h4 className="font-medium text-blue-700 mb-2">Lifestyle Guidance</h4>
                <ul className="list-disc list-inside text-blue-800 space-y-1">
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
              <h4 className="font-medium text-red-700 mb-2 flex items-center">
                <i className="fas fa-exclamation-circle mr-2"></i> Important Disclaimer
              </h4>
              <p className="text-red-600 text-sm">This assessment is provided for informational purposes only and is not a substitute for professional medical advice, diagnosis, or treatment. If you have serious symptoms, please seek immediate medical attention.</p>
            </div>

            <div className="flex space-x-4">
              <Link href="/appointments" className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl transition-colors flex items-center">
                <i className="fas fa-calendar-alt mr-2"></i> Book Appointment
              </Link>
              <Link href="/medical-checkup" className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl transition-colors flex items-center">
        ...
        {/* Quick Actions */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-blue-800 mb-6">What&apos;s Next?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/medical-checkup" className="bg-white rounded-2xl shadow-lg p-6 card-hover block">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-blue-800 mb-2">Complete Checkup</h3>
                <p className="text-gray-600">Get a comprehensive health assessment</p>
              </div>
            </Link>
            <Link href="/appointments" className="bg-white rounded-2xl shadow-lg p-6 card-hover block">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-blue-800 mb-2">See a Doctor</h3>
                <p className="text-gray-600">Schedule an appointment with a specialist</p>
              </div>
            </Link>
            <Link href="/ehr" className="bg-white rounded-2xl shadow-lg p-6 card-hover block">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-blue-800 mb-2">View Records</h3>
